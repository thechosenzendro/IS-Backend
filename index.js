...
function Login(jmeno, heslo, db) {
    ...
    const napsaneHeslo = SHA256(heslo);
...
fs.readFile("./server/login.json", "utf8", (err, data) => {
    if (err) {
        ...
        console.log(Timestamp() + " Auth Read Error: " + err)
        return;
    }
    daticka = data;
    ...
    console.log(Timestamp() + " loginData přečtena.");
    ...
    console.log(Timestamp() + " Autorizační request přijat.")
